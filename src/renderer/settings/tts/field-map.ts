...
export const TTS_FIELD_MAP: Record<string, string> = {
  ...
  "tts-indextts-url":         "ttsIndexttsBaseUrl",
  "tts-indextts-model-dir":   "ttsIndexttsModelDir",
  "tts-indextts-python-path": "ttsIndexttsPythonPath",
  "tts-indextts-port":        "ttsIndexttsPort",
  "tts-indextts-engine-version": "ttsIndexttsEngineVersion",
  "tts-indextts-ref-audio":   "ttsIndexttsRefAudioPath",
  "tts-indextts-prompt-text": "ttsIndexttsPromptText",
...
export const TTS_PROVIDER_FIELDS: Record<string, string[]> = {
  ...
  indextts:        ["tts-indextts-model-dir", "tts-indextts-python-path", "tts-indextts-port", "tts-indextts-url", "tts-indextts-ref-audio", "tts-indextts-prompt-text"],
